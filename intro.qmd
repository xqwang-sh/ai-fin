...
**软件配置：**
1. [ ] 安装 Cursor IDE 并完成基础配置
2. [ ] 安装至少一个 MCP Server（推荐 Context7）
3. [ ] 安装 Superpowers Skills

**动手实践：**
4. [ ] 尝试使用 Agent 模式完成一个简单任务（如创建 Python 项目模板）
5. [ ] 尝试使用 Plan 模式（`Shift+Tab`）规划一个小项目
6. [ ] 使用 Context7 让 AI 查询最新的 Python 库文档
